...
####################################
# CUSTOM_NAME (Legacy) - This section is now superseded by branding_config.json
####################################
...
#             WEBUI_NAME = data["name"] # WEBUI_NAME is now primarily set based on APP_BRANDING_CONFIG in main.py
#     except Exception as e:
#         log.exception(e)
#         pass
